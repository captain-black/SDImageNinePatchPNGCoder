...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of SDImage9PatchPNGCoder.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Captain Black/SDImage9PatchPNGCoder'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Captain Black' => 'captainblack.soul@gmail.com' }
  s.source           = { :git => 'https://github.com/Captain Black/SDImage9PatchPNGCoder.git', :tag => s.version.to_s }
